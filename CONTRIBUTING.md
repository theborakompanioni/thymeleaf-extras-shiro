# Contributing to thymeleaf-extras-shiro
...
with VisSense.js core, please open an issue on the main repository. These are 
...
The [issue tracker](https://github.com/theborakompanioni/thymeleaf-extras-shiro/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/thymeleaf-extras-shiro.git
   # Navigate to the newly cloned directory
   cd thymeleaf-extras-shiro
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/theborakompanioni/thymeleaf-extras-shiro.git
   ```
