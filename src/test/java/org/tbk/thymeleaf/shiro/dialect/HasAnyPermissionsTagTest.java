...
import org.tbk.thymeleaf.shiro.test.mother.PermissionsMother.HasAnyPermissions;
...
public class HasAnyPermissionsTagTest extends AbstractThymeleafShiroDialectTest {
    ...
    private static boolean hasAnyFeatureSanityCheck(Subject subjectUnderTest) {
        return subjectUnderTest.isPermitted(TestPermissions.PERMISSION_TYPE_1_ACTION_1_INST_1.label()) ||
               subjectUnderTest.isPermitted(TestPermissions.PERMISSION_TYPE_1_ACTION_2_EXAMPLE);
    }
